...
# EXERCISE 1 ⬜ | EASY
# ------------------------------------------------------------
# Add a proper FILE HEADER comment to this exercise file.
# It should include:
#   - filename
#   - description
#   - your name
#   - date created
#   - module and lecture reference
#
# Write it as a triple-quoted string at the top of your
# solution file.
# Use the style shown in Part 8 of the lecture.
...
# EXERCISE 2 ⬜ | EASY
# ------------------------------------------------------------
# This code works but has NO comments.
# Add appropriate single-line and inline comments.
# Do NOT change the code - only add comments.
# Make sure every non-obvious line is explained.
...
# EXERCISE 3 ⬜ | EASY
# ------------------------------------------------------------
# These comments are BAD - they state the obvious.
# Rewrite EACH comment to explain WHY, not WHAT.
# Keep the code exactly the same.
...
# Subtract discount from x
final_price = x - discount

# Check if final_price is less than 90
...
# ------------------------------------------------------------
# These comments are WRONG - they don't match the code.
# Find and fix every incorrect comment.
# Do NOT change the code - only fix the comments.
...
is_large = result > 100         # check if result is negative

# Convert to uppercase
name = "anna"
formatted = name.title()        # convert name to lowercase

# Split the string by commas
data = "10 20 30 40"
numbers = data.split()          # split by spaces and convert to int

# Calculate square root
import math
root = math.pow(2, 8)           # calculate square root of 2
...
# ------------------------------------------------------------
# Add TODO, FIXME, NOTE and WARNING tags appropriately.
#
# Given this code with known issues and future plans:
#
# Issue 1: function crashes on empty string input
# Issue 2: doesn't handle lowercase letters
# Future:  should support RNA sequences (U instead of T)
# Warning: result is a percentage, not a decimal
# Note:    assumes sequence contains only valid nucleotides
